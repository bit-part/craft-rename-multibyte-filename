...
/**
 * Rename Multibyte Filename config.php
 *
 * This file exists only as a template for the Rename Multibyte Filename settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'rename-multibyte-filename.php'
